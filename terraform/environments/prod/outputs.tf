...
output "production_features" {
  description = "Features enabled in production environment"
  value = {
    ...
    ssh_access_disabled   = !var.enable_ssh_access
    ebs_encryption        = var.enable_ebs_encryption
    s3_encryption         = var.enable_s3_encryption
...
output "security_summary" {
  description = "Security features summary for production"
  value = {
    waf_protection        = var.enable_waf
    ssh_disabled          = !var.enable_ssh_access
    https_enforced        = var.enable_https
    database_encrypted    = var.db_storage_encrypted
...
output "performance_summary" {
  description = "Performance configuration summary for production"
  value = {
    frontend_instances = {
