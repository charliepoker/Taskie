...
# This file orchestrates all modules to create the complete infrastructure for the dev environment
...
module "database" {
  ...
  redis_multi_az          = false # Single node Redis for dev environment
  tags                    = local.common_tags
}
